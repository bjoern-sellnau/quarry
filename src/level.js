...
const CELLS = [
  { min: [-15, -12, -15], max: [15, 12, 15], color: 0x7e9aa8 },   // 0 start chamber
  { min: [-4, -4, -45], max: [4, 4, -15], color: 0x6d8896 },      // 1 tunnel A->B (-z)
  { min: [-18, -14, -75], max: [18, 14, -45], color: 0x839daa },  // 2 chamber B
  { min: [18, -4, -64], max: [48, 4, -56], color: 0x6d8896 },     // 3 tunnel B->C (+x)
  { min: [48, -16, -78], max: [84, 16, -42], color: 0x8a9ea8 },   // 4 chamber C (arena)
  { min: [15, -4, -4], max: [45, 4, 4], color: 0x6d8896 },        // 5 tunnel A->D (+x)
  { min: [45, -12, -20], max: [75, 12, 16], color: 0x839daa },    // 6 chamber D
  { min: [58, 16, -68], max: [70, 40, -52], color: 0x6d8896 },    // 7 vertical shaft (+y from C)
  { min: [50, 40, -76], max: [86, 72, -44], color: 0x8a9ea8 },    // 8 high chamber E
];
